...
const AboutMeText = () => {
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <h4 class="text-2xl text-cyan mb-6">ML Enthusiast - Data Analyst | Biostatistics - Healthcare Expert</h4>
  ...
  <button className="border border-orange rounded-full py-2 px-4 text-lg flex gap-2 items-center
   hover:bg-orange transition-all duration-500 cursor-pointer md:self-start sm:self-center">
    <a
  href="/resume.pdf"  // Correct path to resume.pdf in the deployed folder
  target="_blank"
